...
type RetellPayloadFieldKey = keyof Omit<
  ...
  | "latest_unit_type_slug"
  | "latest_check_in"
  | "latest_check_out"
  | "latest_stay_nights"
  | "latest_people"
  | "latest_monthly_rate"
  | "latest_precio_mensual_display"
  | "latest_security_deposit"
  | "latest_additional_person_fee"
  | "latest_total_due_now"
  | "latest_total_due_on_docs"
  | "latest_total_rent"
  | "latest_total_price"
  | "latest_pricing_available"
  | "latest_stay_kind"
  | "latest_pricing_data_source"
  | "latest_applied_promo"
  | "latest_pricing_quoted_at"
  | "latest_pricing_spoken_summary"
>;
